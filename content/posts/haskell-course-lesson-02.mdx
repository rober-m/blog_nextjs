...
<p>
  <mark>
    Type checking is the process of verifying and enforcing the constraints of
    types.
  </mark>
</p>

**What does this mean?** It means that each type has its own constraints (E.g., you can't do math with letters. Unless... 🤔 No, no, you can't), and this process checks that those constraints are respected.

<p>
  <b>Why would you do this?</b> To avoid preventable mistakes. If further along
  in your program, you want to add up some numbers and one of them has a letter,
  the program wouldn't know what to do, and it would{' '}
  <SideNote
    content={
      <div>
        <h4>Crash (programming)</h4>
        <p>
          A <b>crash</b>, or <b>system crash</b>, occurs when a program such as
          a software application or an operating system stops functioning
          properly and exits (stops executing/running).
        </p>
      </div>
    }
  >
  ...
  <SideNote
    content={
      <div>
        ...
        <p>
          Bugs are the result of a mistake in the code. They are errors that
          produce an incorrect, unexpected, or unintended result or behaviour in
          the program.
        </p>
        <p>
          {' '}
...
**That allows the compiler to comprehend and reason _quite a lot_ about your program**. Providing you with a pretty effective bug-catching assistant. 💪
...
🥐 :: Food   -- This reads as: 🥐 has type of Food
```
...
And that's it for today! 🙃 Make sure to do the homework and solidify today's concepts! 🤓
...
<Accordion
  ...
  content={
    <p>
      Dynamically typed languages check the types at run-time, and statically
      typed languages, check the types at compile-time.
    </p>
  }
/>
<Accordion
...
In the next lesson, we'll learn about Numbers in Haskell! ➕➖➗✖️ See you there!! 😄
...
<LessonNavigationButtons nextLesson='haskell-course-lesson-03' />
