...
<p>
	<mark>
		You are doing great! With each lesson, you get closer and closer to
		becoming a full-fledged programmer! 🔥 Next lesson, we'll learn about
		characters, lists, and Strings! See you there!{' '}
	</mark>{' '}
	😄
</p>
...
<LessonNavigationButtons nextLesson='haskell-course-lesson-4' />
