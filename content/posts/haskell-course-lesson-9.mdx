...
**Welcome to the first lesson where we're moving beyond just GHCi and creating our first Haskell project!** If you did the last lesson's homework, you are ready for this one! No time to waste! Let's go!! 🔥
...
<p>
  <mark>
    ...
    🤩 That's when you can start to feel the actual power of Haskell! 💪 Make
